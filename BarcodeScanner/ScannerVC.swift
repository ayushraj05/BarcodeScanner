...
enum CameraError: String{
    case invalidDeviceInput = "Something is wrong with camera input."
    case invalidScannedValue = "The value is not valid, only EAN-8 and EAN-13 is accepted."
    case inputIsNotAvailable
